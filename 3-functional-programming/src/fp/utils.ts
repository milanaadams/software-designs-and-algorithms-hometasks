...
export function pipe<A, B, C>(a: A, fb: (a: A) => B, fb2: (a: B) => C): C;
export function pipe<A, B, C, D>(a: A, fb: (a: A) => B, fb2: (a: B) => C, fb3: (a: C) => D): D;
export function pipe<A, B, C, D, E>(a: A, fb: (a: A) => B, fb2: (a: B) => C, fb3: (a: C) => D, fb4: (a: D) => E): E;
